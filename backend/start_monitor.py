...
try:
    ...
    commands = [
        "cd /root/backend && ./venv/bin/pip install streamlit plotly",
        "cd /root/backend && pm2 delete training_monitor || true",
        "cd /root/backend && pm2 start ./venv/bin/streamlit --name training_monitor -- run training_monitor.py --server.port 8501 --server.address 0.0.0.0",
    ...
    print("Streamlit has been successfully started!")
